...
def test_flash_good_lender(w3, eth_flash, good_lender, assert_fail):
    ...
    good_lender.functions.flash_loan_eth(eth_flash.address, ETH_DEPOSIT, DEADLINE).transact({})
...
def test_flash_bad_lender(w3, eth_flash, bad_lender, assert_fail):
    ...
    assert_fail(lambda: bad_lender.functions.flash_loan_eth(eth_flash.address, ETH_DEPOSIT, DEADLINE).transact({}))
